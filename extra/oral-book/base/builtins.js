/* builtins.js · Chunk Lab 内置题库
   2026-09-15 按场景拆分：原 builtin-daily 单 deck → 6 个场景 deck（内容与 cid 零改动）。
     daily-home 居家生活 / daily-social 外出社交 / daily-chat 日常闲聊 /
     daily-basic 口头禅万能 / daily-emotion 情感表达 / daily-work 职场商务
   本文件静态 88 句按场景分组；oral8000.js 文件尾按场景 concat 追加扩展句。
   引用页必须按 builtins.js → oral8000.js → freq-idioms.js 顺序加载。 */
window.BUILTIN = [
  {
    "id": "daily-home",
    "builtin": true,
  ...
  },
  {
    "id": "daily-basic",
    "builtin": true,
    "name": "日常口语 8000 · 口头禅万能",
    "short": "口头禅万能",
    "desc": "万能应答与口头禅（无场景绑定的高频语块）",
    "items": [
      {
...
/* 内置题库构成（2026-09-15 拆分为 6 个场景 deck）：
   - builtins.js 静态句   → 按场景分布在上述 6 个 deck
   - oral8000.js 扩展句   → 文件尾按 DATA_ORAL8000_SCENES 分发到对应 deck
   - freq-idioms.js       → 自注册 builtin-freq-idioms
   - window.BUILTIN_MIGRATION → 老 builtin-daily 档案 key 的场景迁移表（core.js migrateDailySceneKeys）
   引用页加载顺序：builtins.js → oral8000.js → freq-idioms.js。 */
/* 老 builtin-daily 档案 key → 新场景 deck 的迁移映射（2026-09-15 拆分 deck 时生成）。
 * 供 core.js 的 migrateDailySceneKeys 使用：键 = 档案 key 里的 deckId，值 = 归属该 deck 的句子 cid 数组。
 * cid 是内容的稳定哈希 → 往后新增句子无需重新生成本表。 */
window.BUILTIN_MIGRATION = {
  'daily-home': [
    '70190b47', '73225f28', '6abc41f7', '4bb2e115', '2b0c3220', '7f041d4e', '26516f50', 'd89f94fa',
    '42feb2af', '1319af65', '65a045ff', '9e0805f0', '82e48821', '66658ed3', '8094f354', '4eb6f313',
    '0c594885', '3270501d', '742e248f', '0bdabc0d', '69d57e53', '19c737bd', 'b4dc4363', '5ae33cc0',
    '0ab455be', '3d052989', '5b616a39', '1ea989e8', '10dca05a', '1417566d', '304eb970', 'e520881b',
    '61133093', '7036eef2', '2836375b', '3fcc4d24', '1dcd6542', '7849de8e', '382f5358', '959fa9a7',
    '757da6a9', 'a941aad4', 'b2921029', 'b613eb7d', 'b5a62b5d', '6c4276f8', 'd6700842', 'd7c85ebc',
    'c59cc387', '4d62bdfa', '7fde70a6', '22684a18', '7591c63d', 'db783c1d', 'b9aa8c19', '89843067',
    '9c364fa8', 'e24acc99', '8e16eb62', '7bf57efa', 'e8165154', '54010f3c', '3a4b732a', '84f32999',
    'b6567a0a', 'b62f5200', '3df31aab', 'ac537f80', 'b0368ee8', 'af8e14de', 'cd8300eb', 'f1405f3f',
    '13553af7', '2af7c066', '2ca094db', '81537529', 'e72891e5', '4231de9f', 'e13305a9', 'c093035a',
    'b134e4b0', 'bb4983d7', '2684aa5f', 'c0af9f50', '5d687bf0', '3c1a2036', 'af665333', 'b9c23335',
    '73504ae3', '54764003', 'edb7eb4b', 'e0bd95bb', 'e082afdd', 'e31c936a', 'e01f814d', '8c2306cc',
    '0f6c6eb5', '9425b8e6', '39241d16', 'a78144bd', '8c273747', 'a80cfc73', '1381b0a8', '14713e06',
    'de31c7f6', '25f410a9', '14d3f87e', '5b99a19c', '4436b78d', '2d1e7fe6', 'f090a897', 'dfc5d91e',
    '0718c5bc', 'a11e56c2', '40fa1f77', '6a78132a', '2b8d1614', '85c69d3a', '4aeb9a71', '830c8e09',
    'f830f35a', '31bd739b', '0e10399e', 'e808c2e2', 'f256951c', '60c46056', 'e5ed7518', '264a3504',
    '6de68bea', 'd403abf3', '34b89c56', 'f15b18c1', 'bbb7bec1', 'b2294826', 'c7ea95cd', '78e4af03',
    'fb98228c', '70c23bb5', 'fab59b9a', '7389fce9', 'b070daa7', 'b0bc4558', '83eb9b90', 'f1c0fcfb',
    'a36e08cb', 'a73bf6b4', '97500516', '0da18463', 'bb4458df', '95169b06', '1bcdc1c7', '2dc7b93b',
    '257c6484', 'f19ef7b9', '3db64270', '4bc148af', 'd8351b8f', '615604c4', 'ad376550', '83b90662',
    '2601c5bd', 'a155ee83', '3cfec5e3', '27b1176e', '7d234a10', 'a5e554a7', '4778de8a', '2bb9dcf0',
    '5c36ca37', 'fe96fbbe', '9fa6d5b3', '7533e2a5', '4af03e2d'
  ],
  'daily-social': [
    'cff80fb6', '4226408e', 'f03e78e8', 'b3b8b56c', 'c5333fc3', 'e5c1bf50', '9ae0b549', '249e8feb',
    '684f3d80', '5f612d59', 'f900c537', '8e88da8b', '11eab175', 'a502b123', 'ea8bea79', '4a8ecc17',
    '5bd1ca12', '49fecae0', '27e9bd68', '09ee0d9c', '8437bd38', 'b6b38927', '52e57cb1', 'b4d9f9ed',
    '317bf159', 'd6d76e5b', '44614ab3', '2bccbf9f', '0ba46f6f', 'fa0974dd', 'a5220aa4', '4993d618',
    'cd506d36', '79421135', '1a0d45be', '31c49222', '72a8211b', '7c63ccd9', '286efe6b', '5e7afb03',
    '8d72c5ea', 'eb546ded', '15accdce', 'ef7de65b', '966b3754', '9d02a202', '09096d4a', 'f09dfd8b',
    '137ff5fe', '79068a2f', 'ecc1d3c4', 'c5710a04', 'ef48bd78', '4ca097f3', '179cbe0e', 'a46fda11',
    '577c7ac5', '8e299f97', '28fc81b5', 'c3850bef', '5dea8d2a', 'bfe52436', 'b83b9640', 'faaa45bb',
    '32facf35', 'c0724b3e', 'e0229bb6', '8f6161c2', 'cf1b44ab', 'df26fb4e', 'afd0eb9f', '20563507',
    '515d82ef', '9a4f0134', '6fc23ceb', '350e2601', '62ff1252', '352ea243', '141237b8', 'f22bd74d',
    '8eea26b2', '9352bdcd', 'e4eb1b2b', '551d0bc0', 'd7f8b9c8', '777f5c9d', 'ea7d8a4b', '6e85e8be',
    '17386a3e', 'd917bc1b', '17294bac', '880a8346', 'bd951c11', '3ec98065', 'f82f8fcf', 'a08f34b7',
    '81e9a11f', '867d1dff', '284f75cd', '0d6e7a1e', 'ce389d98', '2bfa5969', '433047e6', '01b8d6e2',
    '46bc4117'
  ],
  'daily-chat': [
    '77588aab', '78b2ed9c', '05de33a5', 'efb3c8ea', 'f26b491f', '5b28a18d', '300d8e13', 'fdc5ae18',
    '3edf0897', 'f2d8d822', 'a5117784', '5e6bba59', '129c08c0', 'a3d72107', '8139df49', '6b70763b',
    '53af40c1', 'edcf60c8', 'd338b9bb', 'd10b5dec', '334cfe4a', '7e998d83', '362a9411', '6de73a4a',
    '4c95b52c', 'dd58f6c9', '35fcfee6', 'f5a21d52', '2f17c3e6', 'c55bb082', 'df0d93d3', '3e523059',
    '9850dabd', '2c67da0d', 'adb3d11f', 'b0d272f4', '9e19d0bc', 'f40f7098', '2458e206', 'c8ebde21',
    '841bd042', '9d0c16ea', '09a7c3c3', '6ea7ddb2', 'b9a6bed9', '48a08dbe', 'f265bd24', '574f6eb0',
    '03cbee2b', '21d7bd02', '56db8fc9', 'd68791ff', '1834c3f7', '9b596270', '3a50b844', '0e4cb67e',
    'c530aed7', 'c869e3f3', '7cccaf62', 'af4c7939', 'c0abf276', '2e8d5895', 'd99feea8', '05cc4c9b',
    'c3dee22f', '744c4681', 'f8afdcf8', 'b9af65ab', '1d4b7d2d', 'd463d7c2', 'd1fa43d8', 'c9dfafd6',
    '6db16bc7', 'ad88d5dc', '45ae00d9', 'dc756c88', '7fdbc9e4', '9dd8fc89', '0d637f69', 'f863d500',
    '6c5b5c7b', '978cb905', '381f72db', '319a8e05', '623c5d57', '0307af34', '46893aac', '18e9ee1b',
    '7bec57ab', 'efcd6d0e', '96d9409c', '3aa31e0a', '307d29b1', 'c1caeb1d'
  ],
  'daily-basic': [
    '67ae602e', 'b95cd0f4', '9f813037', '243188cb', '3d04d4e1', '72aa19b1', 'f50d7898', 'c427a713',
    '0f9400f7', '0f83a993', '806439ee', 'a71c1752', 'afa391b8', '85fb293b', '11e9ed12', 'e14abd85',
    'c3147310', 'fb54ce6f', 'd1a382b8', 'ea178218', 'e53f3d82', '22a86a18', 'a964fa8d', '4fad1198',
    'abc317f8', 'd2d4552d', '890b2dc4', '0ca82ddb', '89d8df40', 'd13966c5', '10e9ea4a', 'b6c66834',
    '534483e8', 'a82159aa', '9edbf706', 'c6319b49', '9dc552cd', 'a5317c23', '3a6102e6', 'f7458ab4',
    '0951976a', 'aab6ad64', '725fe013', '59f78fc3', 'bc810920', 'ddab755e', '5010e8ef', '5a4799a1',
    '86ff7ccf', '1792dc97', '45b93a39', 'cd3e07aa', '31d5d360', '2a729d81', '6592bb2c', '9187c8c7',
    'fc023e5e', '85acd6c2'
  ],
  'daily-emotion': [
    '61b69c3a', 'c556a208', 'b0be2b46', 'cb22e2a1', 'c44e93b0', '99621477', 'abfe8204', 'f5fe9a5f',
    'f138b191', '28b5e31b', '0c31e53d', 'c66af01f', 'b6a7287e', '6159c055', '96308679', '79d9ff2f',
    '3243ebfc', '13020328', '93a0fe58', 'd43245c6', '3689d2d6', 'b088786f', '85107210', 'e70c8cf4',
    'b8116edf', '9e2532fc', '21f94209', 'fb895572', 'de2d0d34', 'cd379d3e', '09c464f6', '9042ad50',
    '529f6b92', 'd989d51c', 'db59a3b8', '8a621293', '6ba05043', '6010cb80', 'ac89bfd8', '8ec45499',
    '0f9b4d48', '734357e7', '77eefd93', '2d1602f3', 'de8bc536'
  ],
  'daily-work': [
    '5cac61f5', '99c40243', 'bd1383e5', 'e138468c', '9c89ba9b', '5893e7b7', '00d6253f', '13fee10d',
    '4d2656c9', 'ddff4543', 'edc8aa29', '4cb79c53', 'b45ed857', '4eb3eb33', 'a732da43', '1da8e217',
    'f2c5b8eb', 'dfcf2e40', '475674ed', 'b4cd5f6b', '9a127097'
  ]
};
