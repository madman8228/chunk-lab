...
FILES=(
  ...
  js/idb.js js/batch-sync.js js/icons.js js/chunk-shape.js js/content-repository.js js/sync-resolution.js js/sync-resolution-ui.js js/bridge.mjs js/chunk-engine.mjs js/format.mjs js/ai-prompts.mjs js/backup.mjs js/distractor-cause.mjs
